...
class ConfirmDeleteStretchy(Stretchy):
    ...
    def __init__(self, parent, obj):
        ...
        lines = [
            Text(_("Do you really want to delete the {desc} {label}?").format(desc=obj.desc(), label=obj.label)),
            Text(""),
        ]
        stretchy_index = 0
        fs = obj.fs()
        if fs is not None:
            ...
            if obj.type == "lvm_volgroup":
                ...
                if n == 1:
                    ...
                    things = _("partitions")
            lines.append(Text(_("It contains {n} {things}:").format(n=n, things=things)))
            lines.append(Text(""))
