...
class InstallController(SubiquityController):
    ...
    def config_location(self):
        ...
        if self.app.opts.dry_run:
            return os.path.join('.subiquity/', config_file_name)
        else:
            return os.path.join('/var/log/installer', config_file_name)

    def write_curtin_config(self):
        ident = self._event_syslog_id
        config = self.model.render(syslog_identifier=ident)
