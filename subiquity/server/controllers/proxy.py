...
from subiquitycore.async_helpers import AsyncChannel
    ...
    def start(self):
        if self.model.proxy:
            os.environ['http_proxy'] = os.environ['https_proxy'] = \
              self.model.proxy
            self._set_task = self.set_channel.asend(self.model.proxy)
